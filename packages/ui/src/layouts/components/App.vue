...
import { regionParts } from '../types/regions'
import RouteMetaBar from './common/RouteMetaBar.vue'
import AppSettings from './common/settings/index.vue'
...
import SidebarLayout from './sidebar/index.vue'

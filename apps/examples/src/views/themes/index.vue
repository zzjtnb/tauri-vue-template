...
import { Badge, Card, CardContent, CardDescription, CardHeader, CardTitle, LayoutRuntime, ToggleGroup, ToggleGroupItem } from '@tauri-vue-template/ui'
  ...
  <div class="flex flex-col gap-6">
    ...
    <div class="flex flex-col gap-1">
      ...
      <p class="text-sm text-muted-foreground">
        与 packages/theme/src/styles/theme/tokens/*.css 对齐，展示 6 套主题色和 36 个语义颜色 token。
      </p>
    </div>

...
import type { ChartConfig } from '@tauri-vue-template/ui'
import { Carousel, CarouselContent, CarouselItem, CarouselNext, CarouselPrevious, ChartContainer, ChartLegendContent, ChartTooltipContent } from '@tauri-vue-template/ui'

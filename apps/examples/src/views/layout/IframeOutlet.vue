...
const links = [
  { to: '/layout/content/iframe', title: '说明页', description: '普通 RouterView 内容，用来对照 iframe 路由。' },
  { to: '/layout/content/iframe/local', title: '本地 iframe', description: 'iframeSrc 指向同应用 hidden blank 路由，sandbox 保留 same-origin 供 Vite 模块脚本加载。' },
  { to: '/layout/content/iframe/external', title: '外部 iframe', description: 'iframeSrc 指向外部地图，并透传 allow/referrerPolicy。' },
]
</script>

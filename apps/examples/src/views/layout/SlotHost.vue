...
const nestedRoutes = [
  {
    ...
    children: [
      {
        path: '/layout/regions/areas',
        component: () => import('@/views/layout/AreaOverrides.vue'),
        meta: { title: '区域对象', icon: 'i-lucide-panels-top-left' },
      },
      {
        path: '/layout/regions/named-views',
        component: () => import('@/views/layout/NamedViews.vue'),
        meta: { title: '命名视图', icon: 'i-lucide-route' },
      },
      {
        path: '/layout/content/outlet',
        component: () => import('@/views/layout/OutletControl.vue'),
...
const quickLinks = [
  { to: '/layout/regions/areas', label: '区域对象' },
  { to: '/layout/regions/named-views', label: '命名视图' },
  { to: '/layout/content/outlet', label: '内容接管' },
]
</script>

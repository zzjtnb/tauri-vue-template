...
const links = [
  { to: '/layout', label: '总览', icon: 'i-lucide-layout-dashboard' },
  { to: '/layout/standard', label: '标准布局', icon: 'i-lucide-panel-top' },
  { to: '/layout/regions', label: '区域扩展', icon: 'i-lucide-panels-top-left' },
  { to: '/layout/content', label: '内容出口', icon: 'i-lucide-square-dashed-mouse-pointer' },
  { to: '/layout/state', label: '状态导航', icon: 'i-lucide-history' },
] as const
</script>

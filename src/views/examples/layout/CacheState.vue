...
const links = [
  { to: '/examples/layout/state/cache/alpha', label: '实例 alpha' },
  { to: '/examples/layout/state/cache/beta', label: '实例 beta' },
  { to: '/examples/layout/state/cache/gamma', label: '实例 gamma' },
]
</script>

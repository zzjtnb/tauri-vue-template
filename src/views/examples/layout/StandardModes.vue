...
const modes = [
  { to: '/examples/layout/standard/topnav', name: 'topnav', title: 'Topnav', description: '顶部导航承载主菜单，移动端仍可复用侧边栏作为抽屉菜单。' },
  { to: '/examples/layout/standard/sidebar', name: 'sidebar', title: 'Sidebar', description: '侧边栏承载主菜单，顶部栏保留页面标题、折叠入口和操作区。' },
  { to: '/examples/layout/standard/hybrid', name: 'hybrid', title: 'Hybrid', description: '顶部导航和侧边栏同时存在，适合复杂后台或工作台。' },
  { to: '/examples/layout/standard/blank', name: 'blank', title: 'Blank', description: '不渲染标准 header/sidebar/footer，只保留基础内容出口。' },
] as const

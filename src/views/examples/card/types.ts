 ...
 * ### 类型定义使用示例
 * ```typescript
 * import type { CardBrand, VirtualCard, GenerateCardFunction } from '@/views/examples/card/types'
 *
 * // 定义品牌配置
 ...
 * ### 实际使用示例
 * ```typescript
 * import { generateCard, validateCardNumberDetailed } from '@/views/examples/card/utils/generator'
 * import { BRAND_CONFIG } from '@/views/examples/card/utils/generator'
 *
 * // 生成单张卡片

...
import { Archive, Mail, Search } from 'lucide-vue-next'
import { Button } from '@/components/shadcn-vue/ui/button'
import { ButtonGroup, ButtonGroupSeparator, ButtonGroupText } from '@/components/shadcn-vue/ui/button-group'
...
<template>
  <div class="flex flex-col gap-3">
    ...
    <p class="text-sm text-muted-foreground">
      ButtonGroup 用同一边界组合按钮、输入框和说明文本，避免手写边框拼接。
    </p>
  </div>

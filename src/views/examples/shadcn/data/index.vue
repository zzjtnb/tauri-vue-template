...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@/components/shadcn-vue/ui/card'
import { Pagination, PaginationContent, PaginationEllipsis, PaginationFirst, PaginationItem, PaginationLast, PaginationNext, PaginationPrevious } from '@/components/shadcn-vue/ui/pagination'
import { ScrollArea } from '@/components/shadcn-vue/ui/scroll-area'
import { Separator } from '@/components/shadcn-vue/ui/separator'
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/shadcn-vue/ui/table'

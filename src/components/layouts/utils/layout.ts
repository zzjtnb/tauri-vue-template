import type {
  ...
  ResolvedLayout,
  ResolvedSidebar,
} from '@/components/layouts/types/internal'
import type { Layout } from '@/components/layouts/types/public'
import type { RegionName, RegionPart } from '@/components/layouts/types/regions'
import SettingsTrigger from '@/components/layouts/components/common/settings/Trigger.vue'
import { areaKeys, extraKeys, regionParts } from '@/components/layouts/types/regions'
